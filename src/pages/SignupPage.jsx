...
const CHARIZARD = 'https://upload.wikimedia.org/wikipedia/en/1/1f/Pok%C3%A9mon_Charizard_art.png';
      ...
      <style>{`
        ...
        .charizard-img {
          ...
          filter:
            ...
            drop-shadow(0 0 42px rgba(234,88,12,0.55))
            drop-shadow(0 8px 24px rgba(0,0,0,0.15));
        }
        .glow-orb  { animation: glow-breathe 3.5s ease-in-out infinite; }
        ...
        >
          ...
          <div className="glow-orb absolute inset-0 flex items-center justify-center pointer-events-none">
            <div style={{
              ...
              background: 'radial-gradient(circle, rgba(249,115,22,0.2) 0%, rgba(234,88,12,0.08) 45%, transparent 72%)',
            }}/>
          </div>

          {/* Spinning rings */}
          <div className="ring-cw absolute inset-0 flex items-center justify-center pointer-events-none">
            <div style={{ width: '370px', height: '370px', borderRadius: '50%', border: '1.5px dashed rgba(249,115,22,0.35)' }}/>
          </div>
          <div className="ring-ccw absolute inset-0 flex items-center justify-center pointer-events-none">
            <div style={{ width: '300px', height: '300px', borderRadius: '50%', border: '1.5px dashed rgba(234,88,12,0.25)' }}/>
          </div>
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div style={{ width: '240px', height: '240px', borderRadius: '50%', border: '1px solid rgba(180,90,20,0.15)' }}/>
          </div>
          ...
          <div className="absolute bottom-8 text-center z-10 space-y-1">
            <p className="text-[11px] font-bold tracking-[0.35em] uppercase"
               style={{ color: 'rgba(180,70,10,0.7)' }}>
              Charizard
            </p>
            <p className="text-[10px] tracking-widest uppercase"
               style={{ color: 'rgba(80,40,10,0.4)' }}>
              Born from fire
            </p>
          </div>
